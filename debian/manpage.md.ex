% warp-beacon(SECTION) | User Commands
%
% "July  7 2024"
...
warp-beacon - program to do something

# SYNOPSIS

**warp-beacon** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**warp-beacon** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **warp-beacon** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**warp-beacon** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    warp-beacon. See **foo.conf**(5) for further details.
...
**warp-beacon** provides some return codes, that can be used in scripts:
